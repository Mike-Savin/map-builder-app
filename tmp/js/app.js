...
enableAnimation.$inject = ['$animateProvider'];
...
ngToast.$inject = ['ngToastProvider'];
...
sails.$inject = ['$sailsProvider', 'API'];
...
restangular.$inject = ['$translateProvider'];
topNewsApp.config(restangular);
...
policy.$inject = ['$rootScope', '$state', '$stateParams', 'currentUser'];
...
setHeaders.$inject = ['currentUser', 'Restangular'];
...
User.$inject = ['Restangular', 'currentUser'];
...
currentUser.$inject = ['$injector', 'localStorageService', 'requestedState', 'Restangular'];
...
requestedState.$inject = ['localStorageService'];
...
validation.$inject = ['$filter', 'ngToast'];
...
threejsScene.$inject = ['$rootScope', '$window', 'THREEService'];
...
UsersCollectionsIndexCtrl.$inject = ['$scope', '$state', 'validation', 'currentUser', 'User'];
...
UsersEditCtrl.$inject = ['$scope', '$state', '$stateParams'];
...
UsersMapsIndexCtrl.$inject = ['$scope', '$state', 'currentUser', 'validation', 'Map'];
...
UsersMapsShowCtrl.$inject = ['$scope', '$sails', '$state', '$stateParams', 'currentUser', 'validation', 'Map'];
...
UsersNewCtrl.$inject = ['$scope', '$state', 'validation', 'User'];
...
UsersPasswordsNewCtrl.$inject = ['$scope', '$state', 'validation', 'User'];
...
UsersSessionsNewCtrl.$inject = ['$scope', '$state', 'validation', 'requestedState', 'User'];
...
(function() {
  ...
  THREEService.$inject = ['$log', '$document', '$q', '$rootScope'];
})();
/**!
...
(function() {
  ...
  THREEPlugins.$inject = ['$log', '$document', '$q', '$rootScope'];
})();
/**!
...
(function() {
  ...
  THREETextures.$inject = ['THREEService', '$log', '$document', '$q', '$rootScope'];
})();
(function() {
